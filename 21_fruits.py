def initialize_deck():
    return ['apple', 'banana', 'orange', 'grape', 'pineapple', 'mango', 'strawberry', 'blueberry', 'raspberry', 'blackberry', 'watermelon', 'lemon', 'lime', 'peach', 'pear', 'cherry', 'kiwi', 'pomegranate', 'apricot', 'fig', 'plum']
...
def card_trick():
    ...
    print(f"Your card is the '{deck[10]}' in the final deck!")
